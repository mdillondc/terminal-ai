...
class ConversationManager:
    ...
    def _auto_search_should_search(self) -> bool:
        """
        Decide whether to run regular web search for the current user request using LLM gating.
        ...
        system_prompt = (
            "You decide whether to run a web search for the current user request.\n"
